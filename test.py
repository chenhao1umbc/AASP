...
torch.save([X,Y], 'aasp_test_'+str(f_len)+'by'+str(t_len)+'.pt')
# sio.savemat('test_raw.mat', {'data':samp_pool[1:, :], 'labels':label_str2num_test(tables, label_pool)})  # save raw data and label
